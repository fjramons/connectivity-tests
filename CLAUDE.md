...
3. **Jumphost / VM in Local cloud domain** — can reach Remote cloud
   ...
   source, a filtered spec, and `connectivity-tests.toml` into heredocs
...
IPs/topology of Remote cloud domain and Local cloud domain — they are meant to be regenerated
